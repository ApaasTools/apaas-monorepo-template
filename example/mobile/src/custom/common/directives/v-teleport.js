...
function createPlaceholder(el) {
  const comment = document.createComment('v-teleport placeholder')
 ...
 */
function teleportElement(el, target) {
...
function update(el, binding, vnode, oldVnode) {
  const oldConfig = processDirectiveArguments(binding.oldValue)
